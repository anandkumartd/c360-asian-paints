...
componentDidMount(){
  ...
  var return_time = [];
  var return_cats = ['Interior Walls', 'Exterior Walls', 'Waterproofing', 'Metal Finishes', 'Wood Finishes', 'Wallpaper', 'Adhesives'];
var  array = ['Interior Walls', 'Exterior Walls', 'Waterproofing', 'Metal Finishes', 'Wood Finishes', 'Wallpaper', 'Adhesives'];
...
<Typography gutterBottom>Product Interest Categories</Typography>
<Bar
